...
def review() -> list[Lane]:
    ...
    return [
        ...
        Lane(14, "concurrent-promotion", contains_all(PRODUCTION, ["unique_import_session", "create_new_file_nofollow", "ImportBusy"]) and "concurrent_imports_never_overwrite_promoted_content" in CONCURRENCY, "concurrent imports use unique staging and exclusive final creation"),
