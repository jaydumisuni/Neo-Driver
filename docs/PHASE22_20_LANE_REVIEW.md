...
| 19 | Normal Ubuntu/Windows CI runs Phase 22 static, focused, fixture, and Windows live read-only gates; focused/static proof binds the single shared OEM identity law, exact imported-package path law, public SetupAPI absence/type/UTF-16 boundary, case-insensitive stable ID normalization, live-filter correction, and whitespace-normalized discarded-result detector against drift. |
