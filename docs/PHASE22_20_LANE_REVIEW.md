...
| 14 | Live Windows inventory reads `SPDRP_UPPERFILTERS` and `SPDRP_LOWERFILTERS`, retains those exact lists as evidence, and never automatically blames a filter merely because it exists. |
