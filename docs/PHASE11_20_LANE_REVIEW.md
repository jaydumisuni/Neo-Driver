...
Final branch documentation-state head `51318b88c6759baf891be8865218bf05b2f1dc2e` passed normal CI run `31894803462` on Ubuntu and Windows with the same complete proof chain. That documentation commit landed after PR #19 had already merged, so this follow-up review-record correction carries the final proof text onto canonical `main`.
