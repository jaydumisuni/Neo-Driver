...
17. **Replay/resume continuity** — resume is bound to exact caller, persisted version, plan fingerprint and action identity; stale, replayed, failed-execution and exhausted-state requests fail closed.
